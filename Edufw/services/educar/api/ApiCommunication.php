...
class ApiCommunication 
{
    ...
    {
        if (isset(EWebApp::config()->APP_CI)) {
            ApiCommunication::$ci = EWebApp::config()->APP_CI;
            ApiCommunication::$sitio_nombre = EWebApp::config()->APP_SITIO_NOMBRE;
            ApiCommunication::$sitio_id = EWebApp::config()->APP_SITIO_ID;
            ApiCommunication::$web_service_client_key = EWebApp::config()->APP_WEB_SERVICE_CLIENT_KEY;
            ApiCommunication::$uri_service_api = EWebApp::config()->APP_URI_SERVER_API;
        }    
    }
    ...
    {
        $baseurl = EWebApp::config()->APP_URL;
